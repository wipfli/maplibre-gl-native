...
struct ShaderSource<CollisionCircleProgram> {
    ...
    static constexpr const uint8_t hash[8] = {0xa2, 0xf7, 0xb8, 0xa4, 0xf5, 0x03, 0x82, 0x8a};
    static constexpr const auto vertexOffset = 12547;
    static constexpr const auto fragmentOffset = 13914;
};
