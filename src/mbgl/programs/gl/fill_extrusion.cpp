...
struct ShaderSource<FillExtrusionProgram> {
    ...
    static constexpr const uint8_t hash[8] = {0xc2, 0x44, 0x92, 0x86, 0x34, 0x31, 0x89, 0x9f};
    static constexpr const auto vertexOffset = 24606;
    static constexpr const auto fragmentOffset = 26691;
};
...
/*
uniform mat4 u_matrix;uniform vec3 u_lightcolor;uniform lowp vec3 u_lightpos;uniform lowp float u_lightintensity;uniform float u_vertical_gradient;uniform lowp float u_opacity;attribute vec2 a_pos;attribute vec4 a_normal_ed;attribute vec2 a_centroid;varying vec4 v_color;
