...
struct ShaderSource<FillExtrusionPatternProgram> {
    ...
    static constexpr const uint8_t hash[8] = {0x86, 0xcf, 0x78, 0x92, 0xcd, 0x82, 0x3f, 0x88};
    static constexpr const auto vertexOffset = 26807;
    static constexpr const auto fragmentOffset = 30472;
};
