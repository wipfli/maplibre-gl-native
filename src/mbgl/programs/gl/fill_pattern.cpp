...
struct ShaderSource<FillPatternProgram> {
    ...
    static constexpr const uint8_t hash[8] = {0xaa, 0x69, 0x20, 0x8d, 0x78, 0x26, 0x30, 0x09};
    static constexpr const auto vertexOffset = 21013;
    static constexpr const auto fragmentOffset = 23363;
};
