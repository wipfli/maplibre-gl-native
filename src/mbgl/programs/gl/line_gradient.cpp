...
struct ShaderSource<LineGradientProgram> {
    ...
    static constexpr const uint8_t hash[8] = {0x2d, 0x73, 0x47, 0x52, 0x65, 0xfc, 0xe3, 0x7d};
    static constexpr const auto vertexOffset = 38925;
    static constexpr const auto fragmentOffset = 41885;
};
