...
struct ShaderSource<LinePatternProgram> {
    ...
    static constexpr const uint8_t hash[8] = {0x65, 0xc6, 0x2b, 0x76, 0xd7, 0xa6, 0x45, 0x8d};
    static constexpr const auto vertexOffset = 42684;
    static constexpr const auto fragmentOffset = 47208;
};
