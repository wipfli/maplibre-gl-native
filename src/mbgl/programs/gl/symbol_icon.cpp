...
struct ShaderSource<SymbolIconProgram> {
    ...
    static constexpr const uint8_t hash[8] = {0x3f, 0x72, 0xdc, 0xc1, 0x2c, 0xc9, 0xd0, 0x73};
    static constexpr const auto vertexOffset = 56638;
    static constexpr const auto fragmentOffset = 59545;
};
...
/*
uniform sampler2D u_texture;varying vec2 v_tex;varying float v_fade_opacity;varying float v_visibility;
