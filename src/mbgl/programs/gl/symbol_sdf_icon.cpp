...
struct ShaderSource<SymbolSDFIconProgram> {
    ...
    static constexpr const uint8_t hash[8] = {0xb1, 0x34, 0xf9, 0x3f, 0x73, 0x00, 0x04, 0x36};
    static constexpr const auto vertexOffset = 59977;
    static constexpr const auto fragmentOffset = 64175;
};
