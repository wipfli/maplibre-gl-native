...
struct ShaderSource<SymbolTextAndIconProgram> {
    ...
    static constexpr const uint8_t hash[8] = {0x3f, 0x76, 0xe2, 0x59, 0xd3, 0x46, 0xeb, 0x3f};
    static constexpr const auto vertexOffset = 66038;
    static constexpr const auto fragmentOffset = 70252;
};
